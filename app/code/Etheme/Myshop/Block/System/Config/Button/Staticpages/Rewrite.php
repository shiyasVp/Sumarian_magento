...
{
    const BUTTON_TEMPLATE = 'system/config/button/staticpages/rewrite.phtml';
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(['id' => 'addbutton_button', 'button_label' => __('Rewrite Static Pages to default'), 'button_class' => $buttonClass, 'onclick' => 'window.location.href=\'' . $this->_urlBuilder->getUrl('myshop_admin/system_config_button_staticpages/rewrite') . '\'', 'html_id' => $element->getHtmlId()]);
