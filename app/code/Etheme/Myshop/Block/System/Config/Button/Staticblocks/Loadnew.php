...
class Loadnew extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(['id' => 'addbutton_button', 'button_label' => __('Import Absent default Static Blocks'), 'button_class' => $buttonClass, 'onclick' => 'window.location.href=\'' . $this->_urlBuilder->getUrl('myshop_admin/system_config_button_staticblocks/loadnew') . '\'', 'html_id' => $element->getHtmlId()]);
