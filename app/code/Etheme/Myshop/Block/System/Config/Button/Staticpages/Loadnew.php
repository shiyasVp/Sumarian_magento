<?php /**/
namespace Etheme\Myshop\Block\System\Config\Button\Staticpages;
class Loadnew extends \Magento\Config\Block\System\Config\Form\Field
{
    const BUTTON_TEMPLATE = 'system/config/button/staticpages/loadnew.phtml';
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(['id' => 'addbutton_button', 'button_label' => __('Import Absent default Static Pages'), 'button_class' => $buttonClass, 'onclick' => 'window.location.href=\'' . $this->_urlBuilder->getUrl('myshop_admin/system_config_button_staticpages/loadnew') . '\'', 'html_id' => $element->getHtmlId()]);
