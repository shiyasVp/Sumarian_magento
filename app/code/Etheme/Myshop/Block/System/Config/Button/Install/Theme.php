<?php /**/
namespace Etheme\Myshop\Block\System\Config\Button\Install;
class Theme extends \Magento\Config\Block\System\Config\Form\Field
{
    const BUTTON_TEMPLATE = 'system/config/button/install/theme.phtml';
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData([
            'id' => 'addbutton_button',
            'button_label' => __('Install Theme'),
            'button_class' => $buttonClass,
            'onclick' => 'window.location.href=\'' . $this->_urlBuilder->getUrl('myshop_admin/system_config_button_install/theme') . '\'',
