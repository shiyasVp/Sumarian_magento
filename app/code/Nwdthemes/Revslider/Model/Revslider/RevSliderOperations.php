...
*/
	...
	<head>
		...
		<!-- LOAD REVOLUTION JS FILES -->
		<script type="text/javascript" src="js/themepunch.gs.min.js"></script>
...
ob_end_clean();
		...
		if($export_real){ //only include if real export
			...
			if(!$usepcl){
				...
				$zip->addFile(Framework::$RS_PLUGIN_PATH.'/export/js/jquery.themepunch.revolution.min.js', 'js/jquery.themepunch.revolution.min.js');
				...
				$zip->addFile(Framework::$RS_PLUGIN_PATH.'/export/js/themepunch.gs.min.js', 'js/themepunch.gs.min.js');
				...
				$pclzip->add(Framework::$RS_PLUGIN_PATH.'export/js/jquery.themepunch.revolution.min.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'export/js/', PCLZIP_OPT_ADD_PATH, 'js/');
				...
				$pclzip->add(Framework::$RS_PLUGIN_PATH.'export/js/themepunch.gs.min.js', PCLZIP_OPT_REMOVE_PATH, Framework::$RS_PLUGIN_PATH.'export/js/', PCLZIP_OPT_ADD_PATH, 'js/');
				...
				$pclzip->add(Framework::$RS_PLUGIN_PATH.'public/assets/fonts/font-awesome/css/font-awesome.min.css', PCLZIP_OPT_REMOVE_PATH, RS_PLUGIN_PATH.'public/assets/');
