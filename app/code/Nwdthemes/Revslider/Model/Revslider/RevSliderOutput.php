...
class RevSliderOutput {
    ...
    private function putSlides($gal_ids = array(), $order = array()){
        ...
        $mobile = (strstr($usragent,'Android') || strstr($usragent,'webOS') || strstr($usragent,'iPhone') ||strstr($usragent,'iPod') || strstr($usragent,'iPad') || strstr($usragent,'Windows Phone') || $this->_framework->wp_is_mobile()) ? true : false;
	...
	private function putJS($markup_export = false){
        ...
        <script type="text/javascript">
			...
			<?php if(!$markup_export){ //not needed for html markup export ?>
                ...
                <?php if ($this->slider->getParam("disable_on_mobile","off") === 'on') : ?>
